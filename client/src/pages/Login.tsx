...
//         console.log("hhhhhhhhhhhhhhhhhhhhhhhhhhhp",userCredential)
//         firebaseUser = userCredential.user;
//       } else {
//         const userCredential = await signInWithEmailAndPassword(auth, email, password);
//         console.log("zzzzzzzzzzzzzzzzzzzzzzzzzzzp",userCredential)
//         firebaseUser = userCredential.user;
//       }

//       // Send user data to backend
//       const { data } = await axios.post("http://localhost:8000/user/auth", {
...
//               </TabsContent>
//               <TabsContent value="signup">
//                 <form className="mt-8 space-y-6" onSubmit={(e) => handleSubmit(e, true)}>
//                   <div>
//                     <Input
//                       id="email"
//                       name="email"
